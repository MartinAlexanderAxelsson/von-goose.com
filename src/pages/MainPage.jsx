    ...
    <div>
      ...
      <div className="menus-container">
        <div className="menus-container__wrapper">
          <div style={{ animation: disableAnimations }} onMouseOver={() => setAbout(true)} onMouseLeave={() => setAbout(false)} className={about ? "menus-container__wrapper__menu-1__hover" : "menus-container__wrapper__menu-1"}>
            About
          </div>
        </div>

        <div className="menus-container__wrapper">
          <Link to={"/coding"} style={{ animation: disableAnimations }} onMouseOver={() => setCoding(true)} onMouseLeave={() => setCoding(false)} className={coding ? "menus-container__wrapper__menu-2__hover" : "menus-container__wrapper__menu-2"}>
            Coding
          </Link>
        </div>
        <div className="menus-container__wrapper">
          <div style={{ animation: disableAnimations }} onMouseOver={() => setMusic(true)} onMouseLeave={() => setMusic(false)} className={music ? "menus-container__wrapper__menu-3__hover" : "menus-container__wrapper__menu-3"}>
            Music
          </div>
        </div>
      </div>
      ...
      <div className="links-container">
        <div onMouseOver={() => setAbout(true)} onMouseLeave={() => setAbout(false)} className={about ? "links-container__link-1__displayed" : "links-container__link-1"}>
          ...
          <Link to="/contact" onClick={setContactFormColor(false)}>
            <img className="links-container__link-1__img3" src={mail} alt=""></img>
          </Link>
        </div>
        <Link to={"/coding"} onMouseOver={() => setCoding(true)} onMouseLeave={() => setCoding(false)} className={coding ? "links-container__link-2__displayed" : "links-container__link-2"}>
        ...
        <div onMouseOver={() => setMusic(true)} onMouseLeave={() => setMusic(false)} className={music ? "links-container__link-3__displayed" : "links-container__link-3"}>
