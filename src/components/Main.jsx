    ...
    <div>
      ...
      <div className="menus-container">
        <div className="menus-container__wrapper">
          <div
            ...
            className={
              about
                ? "menus-container__wrapper__menu-1__hover"
                : "menus-container__wrapper__menu-1"
            }
          >
            About
          </div>
        ...
        <div className="menus-container__wrapper">
          <Link
            ...
            className={
              coding
                ? "menus-container__wrapper__menu-2__hover"
                : "menus-container__wrapper__menu-2"
            }
          >
            Coding
          </Link>
        ...
        <div className="menus-container__wrapper">
          <div
            ...
            className={
              music
                ? "menus-container__wrapper__menu-3__hover"
                : "menus-container__wrapper__menu-3"
            }
          >
            Music
          </div>
      ...
      <div className="links-container">
        <div
          ...
          className={
            about
              ? "links-container__link-1__displayed"
              : "links-container__link-1"
          }
        >
        ...
        <Link
          ...
          className={
            coding
              ? "links-container__link-2__displayed"
              : "links-container__link-2"
          }
        >
          <div classname="links-container__link-2__animation">
            <video
              className="links-container__link-2__animation__video"
              autoPlay
              muted
              loop
            >
        ...
        <div
          ...
          className={
            music
              ? "links-container__link-3__displayed"
              : "links-container__link-3"
          }
        >
