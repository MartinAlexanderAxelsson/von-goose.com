    ...
    <>
      <main className="main-coding">
        <div className="main-coding__links">
          ...
          >
            <a className="main-coding__links__link-container__a" href="https://scriptwave.vongoo.se">
              SCRIPTWAVE
            </a>

            {muted === false ? <VolOnIcon style={section === "scriptwave" ? displaySoundIcon : hideSoundIcon} onClick={() => setMuted(muted ? false : true)} /> : <VolOffIcon style={section === "scriptwave" ? displaySoundIcon : hideSoundIcon} onClick={() => setMuted(muted ? false : true)} />}
          </div>
          <div style={sectionStyle.joyride} onMouseEnter={() => handleOnMouseEnter("joyride")} onMouseLeave={() => handleOnMouseLeave()} className="main-coding__links__link-container">
            <a className="main-coding__links__link-container__a" href="https://joyride.digital">
              JOYRIDE.DIGITAL
            </a>
          </div>
          <div style={sectionStyle.scriptbeat} onMouseEnter={() => handleOnMouseEnter("scriptbeat")} onMouseLeave={() => handleOnMouseLeave()} className="main-coding__links__link-container">
            <a className="main-coding__links__link-container__a" href="https://scriptbeat.vongoo.se">
              SCRIPTBEAT
            </a>

            {muted === false ? <VolOnIcon style={section === "scriptbeat" ? displaySoundIcon : hideSoundIcon} onClick={() => setMuted(muted ? false : true)} /> : <VolOffIcon style={section === "scriptbeat" ? displaySoundIcon : hideSoundIcon} onClick={() => setMuted(muted ? false : true)} />}
          </div>
          <div style={sectionStyle.addProject} onMouseEnter={() => handleOnMouseEnter("addProject")} onMouseLeave={() => handleOnMouseLeave()} className="main-coding__links__link-container">
        ...
        <div className="main-coding__display-container">
          {section === "scriptwave" ? (
            <div className="main-coding__display-container__scriptwave">
              <div className="main-coding__display-container__scriptwave__p-container">
                <p className="main-coding__display-container__scriptwave__p-container__p1">IS A MIDI COMPATIBLE SYNTH MADE WITH REACT AND THE WEB AUDIO API</p>
                <p className="main-coding__display-container__scriptwave__p-container__p2">IT IS PLAYABLE VIA YOUR COMPUTER KEYBOARD OR A MIDI DEVICE CONNECTED THROUGH YOUR USB PORT</p>
              ...
              <div className="main-coding__display-container__scriptwave__video-container">
                <video style={{ display: isLoading.scriptwave ? "none" : "unset" }} className="main-coding__display-container__scriptwave__video-container__video" autoPlay muted={muted} loop src={scriptwave_video} type="video/mp4" onLoadedData={() => setIsLoading({ ...isLoading, scriptwave: false })} />
          ...
          {section === "joyride" ? (
            <div className="main-coding__display-container__joyride">
              <p className="main-coding__display-container__joyride__p">IS A WEBSITE MADE FOR PODCAST JOYRIDE, MORE INFO COMING SOON</p>
            </div>
          ) : (
            <div></div>
          )}
          {section === "scriptbeat" ? (
            <div className="main-coding__display-container__scriptbeat">
              <p className="main-coding__display-container__scriptbeat__p">IS AN INTERACTIVE BROWSERBASED DRUMMACHINE AND SEQUENCER, BUILT WITH JAVASCRIPT AND THE WEB AUDIO API</p>

              <div className="main-coding__display-container__scriptbeat__video-container">
                <video style={{ display: isLoading.scriptbeat ? "none" : "unset" }} className="main-coding__display-container__scriptbeat__video-container__video" autoPlay muted={muted} loop src={scriptbeat_video} type="video/mp4" onLoadedData={() => setIsLoading({ ...isLoading, scriptbeat: false })} />
          ...
          {section === "addProject" ? (
            <div className="main-coding__display-container__addproject">
              <img className="main-coding__display-container__addproject__giffy" src={pixelman} alt="Happy pixelman" />
            </div>
          ) : (
            <div></div>
          )}
